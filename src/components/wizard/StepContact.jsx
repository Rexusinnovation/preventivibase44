    ...
    >
      ...
      <div className="max-w-md mx-auto space-y-5 mb-8">
        <div>
          ...
          <input
            ...
            className="w-full bg-white border-2 border-gray-200 rounded-xl p-3.5 text-gray-900 placeholder-gray-400 focus:border-[#D4AF37] focus:outline-none focus:shadow-[0_0_15px_rgba(212,175,55,0.1)] transition-all duration-300"
          />
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">CAP (opzionale)</label>
          <input
            type="text"
            value={formData.zip || ""}
        ...
        <div className="flex items-start gap-3">
          <input
            ...
            className="mt-1 w-4 h-4 rounded border-gray-200 accent-[#D4AF37]"
          />
      ...
      <div className="flex justify-between max-w-md mx-auto">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#D4AF37] to-[#F0D060] text-white font-semibold rounded-xl hover:shadow-[0_0_20px_rgba(212,175,55,0.3)] transition-all duration-300 disabled:opacity-50"
        >
          {isSubmitting ? (
            <>
